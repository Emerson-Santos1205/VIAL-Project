...
**Depends On:** TOOLS-001 — Tool Model, TOOLS-002 — Tool Contract, SDK-001 — Architecture, SDK-002 — Organization API, SDK-003 — Resource API, SDK-004 — Context API, SDK-005 — Decision API, RFC-002, RFC-003, RFC-004, RFC-005, RFC-006
